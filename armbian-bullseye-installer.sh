...
#Welcome
if (whiptail --title "PiNode-XMR Armbian Bullseye (Stable) Installer" --yesno "To install PiNodeXMR using this installer the following conditions are required\n\n* You have logged in as 'root'\n* You created a user called 'pinodexmr'\n* You are still logged in as 'root' now\n\nWould you like to continue?" 12 60); then

		whiptail --title "PiNode-XMR Armbian Bullseye (Stable) Installer" --msgbox "Thanks for confirming\n\nPermissions and Hostnames will now be configured, this will only take a few seconds." 12 78
...
echo '. /home/pinodexmr/armbian-bullseye-install-continue.sh' | sudo tee -a /home/pinodexmr/.profile
