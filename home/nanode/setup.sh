		...
		"3)")CHOICE3=$(whiptail --backtitle "Welcome" --title "Nanode Settings" --menu "\n\nUpdate Tools" 20 60 10 \
				...
				case $CHOICE3 in
					...
					"1)")	if (whiptail --title "Nanode Update Monero" --yesno "This will run a check to see if a Monero update is available\n\nIf an update is found Nanode will perform the update.\n\n***This will take several hours***\n\nWould you like to continue?" 12 78); then
							...
							#Permission Setting
							chmod 755 /home/nanode/current-ver.sh
							chmod 755 /home/nanode/xmr-new-ver.sh
							#Load Variables
							. /home/nanode/current-ver.sh
							. /home/nanode/xmr-new-ver.sh
					...
					"2)")	if (whiptail --title "Update Nanode" --yesno "This will check for updates to Nanode including performance releases, new features and web interface refinements.\n\nWould you like to continue?" 12 78); then
							wget https://raw.githubusercontent.com/monero-ecosystem/PiNode-XMR/ubuntuServer-20.04/new-ver-pi.sh -O /home/nanode/new-ver-pi.sh
							#Permission Setting
							chmod 755 /home/nanode/current-ver-pi.sh
							chmod 755 /home/nanode/new-ver-pi.sh
							#Load Variables
							. /home/nanode/current-ver-pi.sh
					...
					"3)")	if (whiptail --title "Update Onion-Blockchain-Explorer" --yesno "This will check for and install updates to your Blockchain Explorer\n\nIf updates are found they will be installed\n\nWould you like to continue?" 12 78); then
							wget -q https://raw.githubusercontent.com/monero-ecosystem/PiNode-XMR/master/exp-new-ver.sh -O /home/nanode/exp-new-ver.sh 2> >(tee -a /home/nanode/debug.log >&2)
							#Permission Setting
