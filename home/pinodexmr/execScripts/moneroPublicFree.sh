...
#Start Monerod
#The unrestricted RPC (MONERO_PUBLIC_PORT) is for this device only, so it binds loopback. No --rpc-login here:
#monerod applies it to the restricted endpoint as well, which would lock wallets out of DEVICE_IP:MONERO_PORT.
