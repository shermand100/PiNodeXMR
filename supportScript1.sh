...
###
#Start Assist User
if (whiptail --title "PiNode-XMR Support Script #1" --yesno "This script will now perform actions on your device configured exclusively for the benefit of user: dada \n\nThis script will download and install the pre-compiled Monerod for RockPro64 hardware.\n\nWould you like to continue?" 12 78); then
