...
###
#Start Assist User
# if (whiptail --title "PiNode-XMR Support Script #1" --yesno "This script will now perform actions on your device configured exclusively for the benefit of user: ### \n\nIf you are not intended user: ### these actions are likely to affect your device negatively\n\nWould you like to continue?" 12 78); then
