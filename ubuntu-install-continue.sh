...
mv /home/pinodexmr/temp/monero-aarch64-linux-gnu-v0.18.1.2/monero* /home/pinodexmr/monero/build/release/bin/
rm linuxarm8
...
#Move Monerod files to standard location
mv /home/pinodexmr/temp/monero-arm-linux-gnueabihf-v0.18.1.2/monero* /home/pinodexmr/monero/build/release/bin/
rm linuxarm7
rm -R /home/pinodexmr/temp/
fi
#Make dir .bitmonero to hold lmdb. Needs to be added before drive mounted to give mount point. Waiting for monerod to start fails mount.
