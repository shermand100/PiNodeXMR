...
git clone -b ubuntuServer-20.04 --single-branch https://github.com/monero-ecosystem/PiNode-XMR.git 2>&1 | tee -a debug.log
				...
				#Backup User values
					...
					mv /home/pinodexmr/current-ver-p2pool.sh /home/pinodexmr/current-ver-p2pool_retain.sh 2> >(tee -a debug.log >&2)	
					#variables dir
		...
		#Install Update
			...
			sleep 2
				...
				#Restore User Values
					...
					mv /home/pinodexmr/current-ver-p2pool_retain.sh /home/pinodexmr/current-ver-p2pool.sh 2> >(tee -a debug.log >&2)
